...
/*
 Functions:
    void  glm_frustum(float left,    float right,
                                 float bottom,  float top,
                                 float nearVal, float farVal,
                                 mat4  dest)
    void  glm_ortho(float left,    float right,
                               float bottom,  float top,
                               float nearVal, float farVal,
                               mat4  dest)
    ...
    void  glm_persp_decomp_far(mat4 proj, float *farVal)
    void  glm_persp_decomp_near(mat4 proj, float *nearVal)
