...
/*
 Functions:
    mat4s glms_frustum(float left,    float right,
                                  float bottom,  float top,
                                  float nearVal, float farVal)
    mat4s glms_ortho(float left,    float right,
                                float bottom,  float top,
                                float nearVal, float farVal)
    ...
    mat4s glms_perspective(float fovy,
                                      float aspect,
                                      float nearVal,
                                      float farVal)
    ...
    void  glms_persp_decomp_x(mat4s proj, float *left, float *right)
    void  glms_persp_decomp_y(mat4s proj, float *top, float *bottom)
    void  glms_persp_decomp_z(mat4s proj, float *nearv, float *farv)
    void  glms_persp_decomp_far(mat4s proj, float *farVal)
    void  glms_persp_decomp_near(mat4s proj, float *nearVal)
