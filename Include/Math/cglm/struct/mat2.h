...
/*
 ...
 Functions:
    void  glms_mat2_identity(mat2 mat)
    void  glms_mat2_identity_array(mat2 * restrict mat, size_t count)
    void  glms_mat2_zero(mat2 mat)
    void  glms_mat2_mul(mat2 m1, mat2 m2, mat2 dest)
    void  glms_mat2_transpose_to(mat2 m, mat2 dest)
    void  glms_mat2_transpose(mat2 m)
    void  glms_mat2_mulv(mat2 m, vec2 v, vec2 dest)
    float glms_mat2_trace(mat2 m)
    void  glms_mat2_scale(mat2 m, float s)
    float glms_mat2_det(mat2 mat)
    void  glms_mat2_inv(mat2 mat, mat2 dest)
    void  glms_mat2_swap_col(mat2 mat, int col1, int col2)
    void  glms_mat2_swap_row(mat2 mat, int row1, int row2)
    float glms_mat2_rmc(vec2 r, mat2 m, vec2 c)
 */
