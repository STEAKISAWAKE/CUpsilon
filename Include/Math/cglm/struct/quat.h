...
/*
 ...
 Functions:
    ...
    void    glms_quat_identity_array(versor *q, size_t count)
    ...
    versors glms_quat_for(vec3s dir, vec3s fwd, vec3s up)
    versors glms_quat_forp(vec3s from, vec3s to, vec3s fwd, vec3s up)
